...
import styles from '../../CSS/Catalog/Films Pages/FooterPages.module.css'
  ...
  return (
    <footer id="contacts" className={styles['footer-section']}>
      <div className={styles.footer_container}>
        <div className={styles.footer_sectionLinks}>
          <ul className={styles.footer_uselfulLinks}>
            <li className={styles['footer_name-links']}>Useful Links</li>
          ...
          <ul className={styles.footer_developer}>
            <li className={styles['footer_name-links']}>Developer</li>
            <li className={styles.footer_Links}>
              <img src={littel_Star} alt="" className={styles['bg-image-links']}/>
          ...
          <ul className={styles.footer_Contacts}>
            <li className={styles['footer_name-links']}>Contacts</li>
            <li className={styles.footer_Links}>
              <img src={littel_Star} alt="" className={styles['bg-image-links']}/>
        ...
        <div className={styles.footer_sectionPattern}>
          <img src={footerPattern} alt="" className={styles['bg-footer-pattern']}/>
        </div>

        <div className={styles['footer_autor-logo']}>
          <a href="/" onClick={(e) => handleClick(e, '/')} className={styles.autorname}>Alan81</a>
          <a href="/catalog" onClick={(e) => handleClick(e, '/catalog')} className={styles.logofooter}>Studio Ghibli</a>
        </div>
      </div>
    </footer>
  )
